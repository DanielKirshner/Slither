...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("Slither",green,-100,"large")
        message_to_screen("Eat the red apples",white,-30)
        ...
        message_to_screen("Press C to play, P to pause or Q to quit.",blue,180)
...
#This game made by Daniel Kirshner
